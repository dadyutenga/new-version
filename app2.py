...
def main():
    ...
    if (openai_api_key == "" or openai_api_key is None or "sk-" not in openai_api_key) and (anthropic_api_key == "" or anthropic_api_key is None):
        st.write("#")
        ...
        with st.sidebar:
            ...
            available_models = [] + (anthropic_models if anthropic_api_key else []) + google_models + (openai_models if openai_api_key else [])
